...
- **Validation:** Robust Model-vs-Null structural cross-validation (evaluating best Bayesian pose against Scrambled and Translated 2D nulls).
- **Evaluation Speed:** Constant-time $O(GK)$ using the dimension-aware GMM engine.
